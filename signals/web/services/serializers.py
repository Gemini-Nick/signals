...
def serialize_market_context(ctx) -> dict:
    ...
    result = {
        ...
        "position_advice": {
            "base_pct": ctx.position_advice.base_pct,
            "attack_pct": ctx.position_advice.attack_pct,
            "cash_pct": ctx.position_advice.cash_pct,
            "base_direction": ctx.position_advice.base_direction,
            "attack_direction": ctx.position_advice.attack_direction,
            "transition_trigger": ctx.position_advice.transition_trigger,
        } if ctx.position_advice else None,
