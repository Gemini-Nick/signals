...
DATE_PRESETS: dict = {
    ...
    # tier: "major"=指数级大事件(默认显示), "sector"=板块/结构性事件(可展开)
    # 历史里程碑不设 tier，始终显示
    # ── 2024 里程碑（本轮牛市起点）──
    ...
    # ── 2026 Q1 ──
    "4100":      {"date": "2026-01-12", "label": "沪指破4100 — 17连阳+成交3.6万亿天量", "tier": "major"},
    "jiangwen":  {"date": "2026-01-14", "label": "监管降温 — 融资保证金100%+严防大起大落", "tier": "major"},
    "4000bw":    {"date": "2026-02-03", "label": "4000保卫战 — 沪指跌至4002后反弹", "tier": "major"},
    "iran":      {"date": "2026-02-28", "label": "美以打击伊朗 — 哈梅内伊遇袭+霍尔木兹海峡封锁", "tier": "sector"},
    "lianghui":  {"date": "2026-03-04", "label": "两会开幕 — 十五五规划+政策预期", "tier": "major"},
    "4000lost":  {"date": "2026-03-20", "label": "沪指失守4000 — 跌至3957创年内新低", "tier": "major"},
}
