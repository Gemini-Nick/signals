...
# 图表和关键均线分析至少需要 5 年日线，周线由日线 rollup。
INDEX_MA_LOOKBACK_DAYS = 365 * 5
...
DATE_PRESETS: dict = {
    ...
    # 4/3 为科创50/创业板指阶段低点；4/8 停火消息后共同站回 MA8/MA13，作为资金确认日。
    "growth_rebound": {"date": "2026-04-08", "label": "成长反弹确认 — 伊朗风险缓和+科创先行", "tier": "sector"},
}
